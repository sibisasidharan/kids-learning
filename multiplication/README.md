...
A single-file multiplication practice game for kids. Open `index.html` in any browser — no build step, no server, no dependencies. Reached from the site's landing page at `/`, or directly at `/multiplication/`.
